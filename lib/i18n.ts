...
export const en = {
  ...
  statRank: 'Position',
  meLanguage: 'Language',
  langRefreshTitle: 'Change language',
  langRefreshBody: 'For the changes to take effect the app needs to refresh',
...
export const es: Dict = {
  ...
  statRank: 'Posición',
  meLanguage: 'Idioma',
  langRefreshTitle: 'Cambiar idioma',
  langRefreshBody: 'Para que los cambios surtan efecto la app necesita actualizarse',
